...
export function ChevronIcon({ className = '', expanded = true }) {
  return (
    <svg
      className={`h-3.5 w-3.5 shrink-0 transition-transform duration-200 ${expanded ? '' : '-rotate-90'} ${className}`}
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      fill="none"
      stroke="currentColor"
...
export function CheckCircleIcon({ className = 'h-12 w-12' }) {
  return (
    <svg
      className={className}
      xmlns="http://www.w3.org/2000/svg"
