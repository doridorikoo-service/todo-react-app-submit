    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-6 lg:grid lg:grid-cols-[1fr_380px] lg:items-start">
          ...
          {completedTodos.length > 0 && (
            <section className="space-y-3 pt-2">
              <div className="flex items-center gap-3">
                ...
                <p className="rounded-full bg-white/80 px-3 py-1 text-xs font-bold text-slate-500 shadow-sm">
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className="rounded-full bg-white/80 px-3 py-1 text-xs font-bold text-slate-500 shadow-sm transition hover:bg-red-50 hover:text-red-500"
                >
                  완료 항목 정리
                </button>
              </div>
        ...
        <div className="lg:sticky lg:top-6">
          ...
          <section className="mt-4 rounded-3xl border border-white/70 bg-white/75 p-4 shadow-sm backdrop-blur">
